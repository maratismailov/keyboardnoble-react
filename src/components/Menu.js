...
const DictSelectMenu = props => {
  return (
    ...
    <div>
      <details><summary ВОТ ЗДЕЗЬ>{props.placeholder}</summary>
        <details>
          <summary>Cписки частотности/Frequency lists</summary>
          <details>
            <summary>Русский интернет-корпус</summary>
          ...
          <details>
            <summary>Национальный корпус русского языка</summary>
            <a onClick={props.handleSelect}
          ...
          <details>
            <summary>Contemporary fiction</summary>
